...
namespace Repository
{
  ...
  const SearchPath storageRoot = "../SendFile";  // root for [all] server file storage
  const MsgPassingCommunication::EndPoint serverEndPoint("localhost", 9180);  // listening endpoint
  ...
  public:
    ...
    static Files getFiles(std::string pattern,  const SearchPath& path = storageRoot);
  private:
